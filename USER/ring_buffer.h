 ...
 *			when buffer is full)
 */
int RingBuffer_Insert(RINGBUFF_T *RingBuff, const void *dat);
 ...
 *			when buffer is full)
 */
int RingBuffer_InsertMult(RINGBUFF_T *RingBuff, const void *dat, int num);
 ...
 * 			the buffer is empty)
 */
int RingBuffer_Pop(RINGBUFF_T *RingBuff, void *dat);
 ...
 */
int RingBuffer_PopMult(RINGBUFF_T *RingBuff, void *dat, int num);
