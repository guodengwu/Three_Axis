...
{
	//P1ASF = ADCx->ADC_Px;
	if(ADCx->ADC_Px == ADC_P10)				{P1M0 = 0x00;    P1M1 = 0x01;}//设置P1.0为ADC口
	else if(ADCx->ADC_Px == ADC_P11)		{P1M0 = 0x00;    P1M1 = 0x01;}                             
    else if(ADCx->ADC_Px == ADC_P12)		{P1M0 = 0x00;    P1M1 = 0x01;}
	else if(ADCx->ADC_Px == ADC_P13)		{P1M0 = 0x00;    P1M1 = 0x01;}
	else if(ADCx->ADC_Px == ADC_P14)		{P1M0 = 0x00;    P1M1 = 0x01;}
	else if(ADCx->ADC_Px == ADC_P15)		{P1M0 = 0x00;    P1M1 = 0x01;}
	else if(ADCx->ADC_Px == ADC_P16)		{P1M0 = 0x00;    P1M1 = 0x01;}
	else if(ADCx->ADC_Px == ADC_P17)		{P1M0 = 0x00;    P1M1 = 0x01;}
	//else if(ADCx->ADC_Px == ADC_P15)		{P1M0 = 0x00;    P1M1 = 0x01;}
	...
	if(ADCx->ADC_Align == ADC_ALIGN_RIGHT)	{//设置结果右对齐
		ADCCFG = 0x20;                              
		ACC = ADC_RES;                              //A[3:0]存储ADC的12位结果的高4位,A[7:4]为0
		B = ADC_RESL;                               //B存储ADC的12位结果的低8位
	}else if(ADCx->ADC_Align == ADC_ALIGN_LIFT)	{ //设置结果左对齐		
		ADCCFG = 0x00;                             
		ACC = ADC_RES;                              //A存储ADC的12位结果的高8位
		B = ADC_RESL;                               //B[7:4]存储ADC的12位结果的低4位,B[3:0]为0
	}
